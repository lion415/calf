package com.wanda.fuyao.calf.wx.miniapp.controller;
...
public class WxMaUserController {
    ...
    @GetMapping("passWay")
    public String passWay(@PathVariable String appid){
        this.logger.info("passway 不需要认证");
